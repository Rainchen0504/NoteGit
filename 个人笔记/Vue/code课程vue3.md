...
​	Vue提供一个h()函数用于创建vnodes，可以使用render选项来声明渲染函数。**<font color=red>h()函数是对createVNode函数的封装</font>**，判断h函数传入的参数个数和类型执行不同内容。	
...
通过脚手架和Vite构建的项目包含有预先设置好的tsconfig.json文件，可以添加编译时的配置。



可以通过defineComponent()全局API来定义组件类型让TS正确推导出组件选项内的类型。
...
![image-20210722215138665](https://raw.githubusercontent.com/Rainchen0504/picture/master/202211090002563.jpg)
...
![image-20210722214543454](https://raw.githubusercontent.com/Rainchen0504/picture/master/202211090002373.jpg)
...
![image-20210722215933360](https://raw.githubusercontent.com/Rainchen0504/picture/master/202211090002405.jpg)
